...
describe('<CardsProjects>', () => {
  const firstProject = {
    id: 1,
    title: 'Games-Catalog',
    description: 'Site qui présente des consoles et des jeux vidéo, avec une partie admin pour la partie gestion '
      + 'des consoles et des jeux. Ce site a été réalisé en NextJS, Bootstrap et du CSS',
