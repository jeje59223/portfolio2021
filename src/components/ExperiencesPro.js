...
const ExperiencesPro = () => {
    return (
        <section id="experiencesProfessionnelles">
            <div class="container">
                <h2 class="text-center h2ExperiencesProfessionnelles">Expériences Professionnelles</h2>
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p>
                            <span class="fw-bold">Tâches réalisées :</span> Fiabilisation des stocks et du taux de rupture. "commandes, relevés de ruptures, 
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <p>
                            <span class="fw-bold">Tâches réalisées :</span> Apprentissage de plusieurs languages tel que HTML, CSS, Bootstrap,
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <p>
                                <span class="fw-bold">Tâches réalisées :</span> Apprentissage de plusieurs languages tel que HTML, CSS, JavaScript,
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <p>
                                <span class="fw-bold">Tâches réalisées :</span> Développement d'une application permettant la suveillance de l'ensemble 
